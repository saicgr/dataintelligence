...
export const ROLE_TRACKS: Record<RoleKey, string[]> = {
  de: ['python-drills', 'sql-coding', 'spark', 'pyspark', 'sql', 'kafka', 'airflow', 'dbt', 'snowflake', 'databricks', 'modeling', 'python', 'sysd', ...SHIP, 'terraform', 'observability', 'spark-oncall', 'airflow-oncall', 'data-reliability', 'cr-sql', ...CRAFT],
  ...
  sre: ['sysd', 'observability', 'kubernetes', 'terraform', 'security', 'architecture', 'python', 'git', 'docker', 'cicd', 'spark-oncall', 'airflow-oncall', 'data-reliability', ...CRAFT],
  ...
  'applied-data-eng': ['python-drills', 'sql-coding', 'python', 'sql', 'spark', 'pyspark', 'snowflake', 'databricks', 'airflow', 'dbt', 'modeling', 'mlsys', 'data-reliability', ...SHIP, 'observability', ...CRAFT],
  ...
  platform: ['sysd', 'python', 'kafka', 'sql', 'architecture', 'security', 'git', 'docker', 'kubernetes', 'terraform', 'cicd', 'observability', 'airflow-oncall', 'spark-oncall', 'data-reliability', ...CRAFT],
  ...
  ...cloudTracks('gcp'),
  ...cloudTracks('azure'),
  'databricks-de': ['python-drills', 'sql-coding', 'databricks', 'spark', 'pyspark', 'sql', 'dbt', 'modeling', 'python', 'aws', 'data-reliability', ...SHIP, ...CRAFT],
