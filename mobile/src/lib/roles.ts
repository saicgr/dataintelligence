...
function cloudTracks(cloud: 'aws' | 'gcp' | 'azure') {
  return {
    ...
    [`${cloud}-de`]: ['python-drills', 'sql-coding', cloud, 'spark', 'pyspark', 'sql', 'airflow', 'python', 'modeling', ...SHIP, 'terraform', 'observability', ...CRAFT],
...
export const ROLE_TRACKS: Record<RoleKey, string[]> = {
  de: ['python-drills', 'sql-coding', 'spark', 'pyspark', 'sql', 'kafka', 'airflow', 'dbt', 'snowflake', 'databricks', 'modeling', 'python', 'sysd', ...SHIP, 'terraform', 'observability', 'spark-oncall', 'airflow-oncall', 'cr-sql', ...CRAFT],
  analytics: ['sql-coding', 'sql', 'dbt', 'modeling', 'snowflake', 'python', 'bi', 'looker', 'statistics', 'aws', 'gcp', ...SHIP, 'cr-sql', ...CRAFT],
  ...
  be: ['python-drills', 'sql-coding', 'apis', 'databases', 'python', 'typescript', 'sysd', 'sql', 'architecture', 'kafka', ...SHIP, 'kubernetes', 'observability', ...CRAFT],
  aais: ['python-drills', 'python', 'deep-learning', 'statistics', 'mlsys', 'llms', 'evals', 'rag', 'agents', 'vectordb', 'git', 'docker', ...CRAFT],
  sre: ['sysd', 'observability', 'kubernetes', 'terraform', 'security', 'architecture', 'python', 'git', 'docker', 'cicd', 'spark-oncall', 'airflow-oncall', ...CRAFT],
  ...
  swe: ['python-drills', 'sql-coding', 'python', 'typescript', 'sysd', 'sql', 'architecture', ...SHIP, 'kubernetes', 'observability', ...CRAFT],
  ai: ['python-drills', 'llms', 'rag', 'agents', 'vectordb', 'prompt', 'evals', 'python', 'mlsys', ...SHIP, 'prompt-lab', ...CRAFT],
  ...
  agenteng: ['python-drills', 'agents', 'llms', 'rag', 'prompt', 'evals', 'vectordb', 'python', ...SHIP, 'prompt-lab', ...CRAFT],
  ...
  platform: ['sysd', 'python', 'kafka', 'sql', 'architecture', 'security', 'git', 'docker', 'kubernetes', 'terraform', 'cicd', 'observability', 'airflow-oncall', 'spark-oncall', ...CRAFT],
  devops: ['sysd', 'python', 'architecture', 'security', 'git', 'docker', 'kubernetes', 'terraform', 'cicd', 'observability', ...CRAFT],
  ...
  ...cloudTracks('gcp'),
  ...cloudTracks('azure'),
  'databricks-de': ['python-drills', 'sql-coding', 'databricks', 'spark', 'pyspark', 'sql', 'dbt', 'modeling', 'python', 'aws', ...SHIP, ...CRAFT],
  'databricks-ml': ['python-drills', 'databricks', 'mosaic', 'mlsys', 'python', 'llms', 'evals', 'spark', ...SHIP, ...CRAFT],
  'databricks-arch': ['databricks', 'architecture', 'security', 'spark', 'sql', 'aws', 'git', 'terraform', 'cicd', 'observability', ...CRAFT],
  'snowflake-de': ['sql-coding', 'snowflake', 'sql', 'dbt', 'modeling', 'python', 'aws', 'git', 'cicd', ...CRAFT],
  'snowflake-arch': ['snowflake', 'architecture', 'security', 'sql', 'modeling', 'aws', 'git', 'terraform', ...CRAFT],
